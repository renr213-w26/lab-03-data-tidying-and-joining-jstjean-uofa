...
-   Plot should be customized in at least one way – you could use a different than default color scale, or different than default theme, or some other customization.
    ...
    y= annual_inflation, colour = country, shape = country)) +
      ...
      labs(
        title = "Annual Inflation Rates for Developed Countries Across the World",
        subtitle = "1993-2021",
        x = "Year",
        y = "Inflation (%)",
        colour = "Country",
    ...
    Comment: The patterns of this plot reveal that Australia, Canada and France during most years are expieriencing an increase in inflation while Japan is often near 0% or in the negatives (decrease). I am not very familiar with Japan's economy so this is surprising to me. It is not surprising to me that Canada and France follow similar patterns but Australia being often much higher is also a surprise.
